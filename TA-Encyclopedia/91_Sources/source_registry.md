...
| SRC-0015 | OpenUSD 官方文档入口 | official | https://openusd.org/release/index.html | USD, OpenUSD, Universal Scene Description | source-registered/version-review-needed | 2026-07-01 | 已登记官方文档入口；USD schema、插件能力、DCC/引擎导入行为需按项目工具版本复核。 |
